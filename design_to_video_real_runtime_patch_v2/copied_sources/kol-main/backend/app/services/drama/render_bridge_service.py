...
from app.services.drama.drama_quality_validator import FakeDramaValidator

_telemetry_engine = DramaTelemetryEngine()
_validator = FakeDramaValidator()
_veo_translator = DramaVeoPromptTranslator()
...
class RenderBridgeService:
    ...
    def build(
        ...
        *,
        ...
        # Attach a pre-built Veo-ready prompt extension so callers can read
        # ``bridge_payload["veo_prompt_extension"]`` and append it to the
        # base scene visual_prompt before submitting to VeoAdapter.
        bridge_payload["veo_prompt_extension"] = _veo_translator.translate(
            base_prompt="",
