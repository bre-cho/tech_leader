...
class RenderJob(Base):
    ...
    routing_profile: Mapped[str] = mapped_column(String(64), nullable=False, default="cinematic_ads")
    ...
    recovery_status: Mapped[str | None] = mapped_column(String(32), nullable=True, index=True)
    last_recovery_scan_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), nullable=True)
