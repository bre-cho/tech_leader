...
class RenderSceneTask(Base):
    ...
    recovery_status: Mapped[Optional[str]] = mapped_column(String(32), nullable=True, index=True)
    dead_lettered_at: Mapped[Optional[datetime]] = mapped_column(DateTime, nullable=True)
    manual_retry_requested_at: Mapped[Optional[datetime]] = mapped_column(DateTime, nullable=True)
