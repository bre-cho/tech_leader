...
class TechnicalLeadRuntime:
    ...
    def __init__(self) -> None:
        ...
        self.image_bridge = RealImageProviderBridge()
        self.video_bridge = RealVideoRenderBridge()
    ...
    def run_phase1(self, payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        generated_variants = self.image_bridge.generate_variants(
        ...
        scored = []
        for concept in generated_variants:
    ...
    def run_after_image_selected(self, payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        render_plan = self.video_bridge.build_render_request(project_id, trace_id, story, payload)
